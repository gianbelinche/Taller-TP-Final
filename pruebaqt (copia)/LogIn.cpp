...
void LogIn::setUpThird() {
    ...
    this->comboBox2.show();
    this->label1.setGeometry(QRect(262, 140, 100, 55));
    this->label2.setGeometry(QRect(262, 210, 100, 55));
    this->label1.setText("Elegir Raza");
    this->label2.setText("Elegir Clase");
