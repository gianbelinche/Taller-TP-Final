...
Attack::Attack(SDL_Renderer *renderer, AttackType type, uint16_t aPosX, 
    ...
    switch (type) {
        case SWORD_ATTACK:
            ...
            vertClips = SWORD_ATTACK_HOR_SPRITES;
            horClips = SWORD_ATTACK_VERT_SPRITES;
        ...
        case AXE_ATTACK:
            ...
            vertClips = AXE_ATTACK_HOR_SPRITES;
            horClips = AXE_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
        ...
        case HAMMER_ATTACK:
            ...
            vertClips = HAMMER_ATTACK_HOR_SPRITES;
            horClips = HAMMER_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
        ...
        case FRESNO_BAR_ATTACK:
            ...
            vertClips = FRESNO_BAR_ATTACK_HOR_SPRITES;
            horClips = FRESNO_BAR_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
        ...
        case ELFIC_FLUTE_ATTACK:
            ...
            vertClips = ELFIC_FLUTE_ATTACK_HOR_SPRITES;
            horClips = ELFIC_FLUTE_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
        ...
        case BACULO_NUDOSO_ATTACK:
            ...
            vertClips = BACULO_NUDOSO_ATTACK_HOR_SPRITES;
            horClips = BACULO_NUDOSO_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
        ...
        case BACULO_ENGARZADO_ATTACK:
            ...
            vertClips = BACULO_ENGARZADO_ATTACK_HOR_SPRITES;
            horClips = BACULO_ENGARZADO_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
        ...
        case SIMPLE_BOW_ATTACK:
            ...
            vertClips = SIMPLE_BOW_ATTACK_HOR_SPRITES;
            horClips = SIMPLE_BOW_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
        ...
        case COMPOSED_BOW_ATTACK:
            ...
            vertClips = COMPOSED_BOW_ATTACK_HOR_SPRITES;
            horClips = COMPOSED_BOW_ATTACK_VERT_SPRITES;
            maxFrame = vertClips * horClips;
